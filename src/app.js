(function() {
    ...
    window.addEventListener('message', function(event) {
        ...
        if (data.action === 'openReport' || data.type === 'openReport') {
            if (data.type === 'INIT') {
            ...
            var logoUrl = data.logoUrl || 'https://modora.xyz/brands/m-white.png';
            state.logoUrl = logoUrl;
            var logoEl = document.getElementById('modoraLogo');
            if (logoEl && logoUrl) {
                logoEl.src = logoUrl;
            ...
            var logoStatsEl = document.getElementById('modoraLogoStats');
            if (logoStatsEl) {
                logoStatsEl.src = state.logoUrl || 'https://modora.xyz/brands/m-white.png';
                logoStatsEl.classList.remove('hidden');
            }
            openServerStatsPanel(data.stats || {});
        } else if (data.type === 'serverStatsResult' && data.data) {
            ...
            openServerStatsPanel(data.data.stats || {});
